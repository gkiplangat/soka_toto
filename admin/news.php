...
<main class="mt-5 pt-3">
    <div class="container-fluid">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#addNews">
                            Add New
                        </button>
                    </div>
        ...
        <div class="modal fade" id="addNews" tabindex="-1" aria-labelledby="addItemModalLabel" aria-hidden="true">
                    ...
                    <div class="modal-body">
                        <form id="addItemForm" action="add_news.php" method="POST" enctype="multipart/form-data">
                            <div class="mb-3">
                                ...
                                <select class="form-control" id="department" name="department_assoc" required>
                   ...
                   $conn->close();
                     ?>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="name" name="event_title"
                                    placeholder="Enter Event Title" required />
                            </div>
                            <div class="mb-3">
                                <label for="position" class="form-label">Event Description</label>
                                <textarea class="form-control" id="position" name="event_description"
                                    placeholder="Enter Event Description" rows="4" required>
                    </textarea>
                            </div>

                            <div class="mb-3">
                                <label for="phone" class="form-label">Venue</label>
                                <input type="text" class="form-control" id="phone" name="venue"
                                    placeholder="Where will the event Happen? " required />
                            </div>
